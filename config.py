...
class Config:
    ...
    DATA_VERSION = env('OPENTARGETS_DATA_VERSION', default='18.08') # TODO - would be better to throw an error instead of falling back to a default if this parameter is not set. 
